package org.bwajtr.samples.views.helloworld;
...
import org.bwajtr.samples.data.service.SamplePersonService;
...
@Route(value = "hello-world/:samplePersonID?/:action?(edit)")
@RouteAlias(value = "")
@Uses(Icon.class)
public class HelloWorldView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "hello-world/%s/edit";
    ...
    private final Binder<SamplePerson> binder;
    ...
    public HelloWorldView(SamplePersonService samplePersonService) {
        ...
        grid.addColumn(importantRenderer).setHeader("Is important").setAutoWidth(true);
